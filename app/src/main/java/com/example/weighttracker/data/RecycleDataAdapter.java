...
import com.example.weightTrackerApp.MainActivity;
import com.example.weightTrackerApp.R;
import com.example.weightTrackerApp.ui.home.EditDataFragment;
import com.example.weightTrackerApp.ui.home.EditDataFragmentArgs;
import com.example.weightTrackerApp.ui.home.HomeFragment;
import com.example.weightTrackerApp.ui.home.HomeFragmentDirections;
...
public class RecycleDataAdapter extends RecyclerView.Adapter<RecycleDataAdapter.ViewHolder> {
    ...
    public RecycleDataAdapter(Context context, List<HashMap> data) {
        ...
        this.dataSource = new weightDataSource(context);
        this.mData = data;
    }
    ...
    private void DeleteButtonOnClick(View view, String id)
    {
        ...
        dataSource.deleteweightDatabase(id);
